...
namespace BIRA_Issue_Tracker.Controllers
{
    public class IssuesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,State,Date")] Issue issue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,State,Date")] Issue issue)
        {
            if (ModelState.IsValid)
            {
